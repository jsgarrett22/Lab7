...
/**
 * Class used to generate, validate and calculate winning condition based on computer and human picks
...
public class RPSLSpock {
    ...
    /**
     * Validates whether a pick is 'Rock', 'Paper', 'Scissors', 'Lizard' or 'Spock'
     * @param pick computer or human pick
     * @return a boolean depicting if the passed in pick is 'Rock', 'Paper', 'Scissors', 'Lizard' or 'Spock'
     */
     ...
     * @return a random String value in the form of 'Rock', 'Paper', 'Scissors', 'Lizard', or 'Spock'
     */
    ...
    /**
     * Calculates whether the computer or human wins based on picks
     * @param c_pick computer pick
     * @param h_pick human pick
     * @return a boolean value based on the condition of both human and computer pick values
     */
